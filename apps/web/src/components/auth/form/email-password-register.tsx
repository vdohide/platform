...
export const EmailPasswordRegister = ({ className }: { className?: string }) => {
    ...
    const onSubmit = async (values: RegisterFormValues) => {
        ...
        try {
            ...
            if (data) {
                toast.success("Registration successful. Please verify your email.", { id: toastId, richColors: true });
                        ...
                        <FieldGroup data-slot="checkbox-group">
                            <Field orientation="horizontal">
                                <Checkbox
                                    ...
                                    disabled={form.formState.isSubmitting}
                                />
                                <FieldLabel htmlFor={field.name}>Agree to terms and conditions</FieldLabel>
                            </Field>
